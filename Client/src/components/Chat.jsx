...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-y-scroll relative backdrop-blur-lg'>
          ...
          return (
            ...
            >
              ...
              {msg.image ? (
                ...
                <p className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg break-all text-white 
                  ${isCurrentUser ? 'bg-violet-500/30 rounded-br-none' : 'bg-gray-700 rounded-bl-none'}`}>
                  {msg.text}
                </p>
              )}
      ...
      {/* --- Bottom Area --- */}
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black bg-opacity-40'>
